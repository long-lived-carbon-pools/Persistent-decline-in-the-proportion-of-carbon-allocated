...
nc_paths=[r"data/3Supplementary Fig/Supplementary Fig. 8/1.nc"]
na_shp=r"map/Koppen_1991_2020_NA_big7.shp"
eu_shp=r"map/欧洲7类.shp"
out_png_best10=r"results/3Supplementary Fig/Supplementary Fig. 8.png"
