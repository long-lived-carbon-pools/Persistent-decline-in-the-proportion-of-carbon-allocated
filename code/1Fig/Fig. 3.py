...
recon_path=r"data/4TRW/tree_ring4 - AgeDepSpline(EPS0.85).nc"
model_path=r"data/6Sample data/npp/1_ISBA-CTRIP.nc"
world_shp=r"map/World.shp"
na_clim_shp=r"map/Koppen_1991_2020_NA_big7_simple.shp"
eu_clim_shp=r"map/欧洲7类-class.shp"
NA_r_diff_dir=r"data/1Fig/Fig. 3/1"
na_raw_dir=r"data/1Fig/Fig. 3/2"
EU_r_diff_dir=r"data/1Fig/Fig. 3/3"
eu_raw_dir=r"data/1Fig/Fig. 3/4"
