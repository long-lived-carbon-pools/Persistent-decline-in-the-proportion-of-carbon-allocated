...
csv_na=r"1Fig/Fig. 1/data/1.csv"
excel_na=r"1Fig/Fig. 1/data/2.xlsx"
world_na=r"map/World.shp"
koppen_na=r"map/Koppen_1991_2020_NA_big7.shp"
nc_na=r"TRW/tree_ring4 - AgeDepSpline(EPS0.85).nc"
csv_eu=r"1Fig/Fig. 1/data/3.csv"
stations_eu=r"1Fig/Fig. 1/data/4.csv"
world_eu=r"map/World.shp"
koppen_eu=r"map/欧洲7类.shp"
nc_eu=r"TRW/tree_ring4 - AgeDepSpline(EPS0.85).nc"
extra_site_csv=r"1Fig/Fig. 1/data/5.csv"
npp_site_csv=r"1Fig/Fig. 1/data/6.csv"
out_png=r"results/1Fig/Fig. 1.png"
size_flux=80
size_npp=80
size_tree=100
lw_tree=1.2
