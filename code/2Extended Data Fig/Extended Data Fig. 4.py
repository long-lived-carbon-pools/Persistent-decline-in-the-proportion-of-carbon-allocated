...
a_path=r"4TRW/tree_ring4 - AgeDepSpline(EPS0.85).nc"
b_dir=r"6sample data/npp"
world_shp=r"map/World_countries.shp"
out_dir_grid=r"results/2Extended Data Fig/Extended Data Fig. 4"
...
for ax,item in zip(axes,results_top):
    ...
    ax.text(0.02,0.02,f'{item["name"]}\nMedian r={item["median"]:.2f}',transform=ax.transAxes,ha="left",va="bottom",fontsize=12,path_effects=[pe.withStroke(linewidth=1.2,foreground="white")])
...
out_grid=os.path.join(out_dir_grid,"Extended Data Fig. 4.png")
