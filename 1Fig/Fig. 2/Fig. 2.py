...
npp_path=r"D:\all\data\npp\1_ISBA-CTRIP.nc"
age_path=r"D:\all\data\tree_ring4 - AgeDepSpline(EPS0.85).nc"
eu_shp_path=r"D:\all\data\世界底图\欧洲7类-class.shp"
na_shp_path=r"D:\all\data\世界底图\Koppen_1991_2020_NA_big7_simple.shp"
shp_world=r"D:\all\data\世界底图\World.shp"
out_dir=r"D:\all\1Fig\Fig. 2"
...
ax_d.text(0.78,0.3,"r = 0.75\np < 0.001",
          transform=ax_d.transAxes,
          ha="left",va="bottom",fontsize=24)

ax_c.text(0.28,0.3,"r = 0.8\np < 0.001",
