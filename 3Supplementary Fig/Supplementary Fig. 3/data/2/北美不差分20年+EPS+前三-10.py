...
recon_path=r"D:\170043\3\tree_ring4 - AgeDepSpline.nc"
model_dir=r"D:\Model data\NPP-TRENDY\nppS2\9-8\1700-2"
shp_path=r"D:\\map2\\世界底图\\Koppen_1991_2020_NA_big7.shp"
out_dir=r"D:\170043\北美图4\不差分\合成线段"
out_png=os.path.join(out_dir,"北美不差分20年+EPS+前三.png")
...
MIN_N=10
A_PAD_FRAC=0.04
label_map={1:"A",2:"B",3:"C",4:"Dfa",5:"Dfb",6:"D other",7:"E"}
base_classes=[1,2,3,4,5,6,7]
agg_defs={102:("Warm",[1,2,3,4,5]),103:("Cold",[6,7]),104:("All",[1,2,3,4,5,6,7])}
plot_order=[1,2,3,4,5,6,7,102,103,104]
legend_pos={1:"lower right",2:"lower right",3:"lower center",4:"lower center",5:"lower right",6:"lower right",7:"lower right",102:"lower right",103:"lower right",104:"lower right"}
...
def main():
    ...
    for fp in files:
        ...
        R=rolling_corr(A,B,WIN,MIN_N)
        yrs_roll=common[WIN-1:]
    ...
    fig,axes=plt.subplots(2,5,figsize=(16,7),constrained_layout=True);axes=axes.ravel()
