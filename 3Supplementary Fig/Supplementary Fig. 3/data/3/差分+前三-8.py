...
out_dir=r"D:\170043\欧洲图4\合成线段"
out_png=os.path.join(out_dir,"差分+前三.png")
...
MIN_N=10
A_PAD_FRAC=0.04
label_map={2:"B",3:"C",4:"Dfa",5:"Dfb",6:"D other"}
base_classes=[2,3,4,5,6]
agg_defs={102:("Warm",[1,2,3,4]),103:("Cold",[5,6]),104:("All",[2,3,4,5,6])}
plot_order=[2,3,4,5,6,102,103,104]
