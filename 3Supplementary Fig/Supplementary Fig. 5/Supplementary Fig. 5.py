...
NA_r_diff_dir=r"D:\all\3Supplementary Fig\Supplementary Fig. 5\data\1"
na_raw_dir=r"D:\all\3Supplementary Fig\Supplementary Fig. 5\data\2"
EU_r_diff_dir=r"D:\all\3Supplementary Fig\Supplementary Fig. 5\data\3"
eu_raw_dir=r"D:\all\3Supplementary Fig\Supplementary Fig. 5\data\4"
out_dir=r"D:\all\3Supplementary Fig\Supplementary Fig. 5"
os.makedirs(out_dir,exist_ok=True)
out_png=os.path.join(out_dir,"Supplementary Fig. 5.png")
